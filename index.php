...
<body>
	...
	<div class="content">
		...
		<center>
			...
			<a href="view_recs.php" id="home"><img src="images/folder.png">View Records</a>&nbsp;
			<a href="add_rec.php" id="home"><img src="images/add.png">Add New Record</a>&nbsp;
			<a href="intake.php" id="home"><img src="images/file.png">New Intake Form</a>
		</center>
	</div>
	</div>
</body>
