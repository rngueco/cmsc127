                ...
                <div class="col-lg-12 col-md-12" id="toRep">
                    <form action="update_intake.php" method="post">
                        <div>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-3 col-lg-3">
                                        <div class="form-group">
                                           ...
                                           <input type='text' class="form-control" name='lname' id="lname" value="<?=$open['LNAME']?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label for="fname">First Name</label>
                                            <input type='text' class="form-control" name='fname' id="fname" value="<?=$open['FNAME']?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-lg-3">
										<div class="form-group">
											<label for="mi">Middle Initial</label>
											<input type='text' class="form-control" name='minitial' maxlength="1" id="mi" value="<?=$open['MI']?>">
										</div>
                                    </div>
									...
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											...
											<input type="number" class="form-control" name="age" id="age" min="0" value="<?=$open['AGE']?>">
										</div>
									</div>
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											<label for="weight">Weight (in lbs)</label>
											<input type="number" class="form-control" name="weight" id="weight" min="0" value="<?=$open['WEIGHT']?>" required>
										</div>
									</div>
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
									...
									<div class="col-md-4 col-lg-4">
										<div class="form-group">
											...
											<input type="date" class="form-control" name="birthDate" id="bday" value="<?=$open['BIRTHDATE']?>">
										</div>
									</div>
                                    <div class="col-md-8 col-lg-8">
                                        <div class="form-group">
                                            <label for="bplace">Birthplace</label>
											<input type="text" class="form-control" name="birthplace" id="bplace" value="<?=$open['BIRTHPLACE']?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
								...
								<div class="panel-body">
									<div class="col-md-9 col-lg-9">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="provAddress" id="provadd" value="<?=$open['PROV_ADD']?>">
										</div>
									</div>
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											<label for="provzip">ZIP Code</label>
											<input type="text" class="form-control" name="provZIP" id="provzip" maxlength="4" pattern="[01-9]{4,}" value="<?=$open['PROV_ZIP']?>">
										</div>
									</div>
									...
									<div class="col-md-9 col-lg-9">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="presentAddress" id="presadd" value="<?=$open['PRES_ADD']?>">
										</div>
									</div>
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											<label for="preszip">ZIP Code</label>
											<input type="text" class="form-control" name="presZIP" id="preszip" maxlength="4" pattern="[01-9]{4,}" value="<?=$open['PRES_ZIP']?>">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="panel-body">
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="religion" id="rel" value="<?=$open['RELIGION']?>">
										</div>
									</div>
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											<label for="occu">Occupation</label>
											<input type="text" class="form-control" name="occupation" id="occu" value="<?=$open['OCCU']?>">
										</div>
									</div>
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											<label for="minc">Monthly Income</label>
											<input type="number" class="form-control" name="monthlyIncome" id="minc" value="<?=$open['M_INCOME']?>">
										</div>
									</div>
									<div class="col-md-3 col-lg-3">
										<div class="form-group">
											...
											<div class="input-group input-group-md">
												...
												<input type="text" class="form-control" name="contactNumber" id="cpnum" maxlength="9" pattern="[01-9]{9,}" value="<?=$open['CNUM']?>">
											</div>
										</div>
									</div>
									<div class="col-md-4 col-lg-4">
								...
								<div class="panel-body">
									...
									<div class="col-md-12 col-lg-12">
										<div class="form-group">
											...
											<textarea class="form-control" rows="5" name="diagnosis" id="comment" ><?=$open['DIAG']?></textarea>
                                        </div>
									</div>
									<div class="col-md-12 col-lg-12">
										<?php
										...
										<div class="form-group">
											...
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Heart" <?php if($heart!==false) echo "checked"; ?>>Heart
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Urinary System" <?php if($urinary!==false) echo "checked"; ?>>Urinary System
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Eyes" <?php if($eyes!==false) echo "checked"; ?>>Eyes
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Ears" <?php if($ears!==false) echo "checked"; ?>>Ears
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Limbs" <?php if($limbs!==false) echo "checked"; ?>>Limbs
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Fingers and Toes" <?php if($fAndT!==false) echo "checked"; ?>>Fingers and Toes
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Tongue" <?php if($tongue!==false) echo "checked"; ?>>Tongue
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Skull" <?php if($skull!==false) echo "checked"; ?>>Skull
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Mandible" <?php if($mandible!==false) echo "checked"; ?>>Mandible
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Retarded Growth" <?php if($rG!==false) echo "checked"; ?>>Retarded Growth
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Mental Retardation" <?php if($mR!==false) echo "checked"; ?>>Mental Retardation
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Nose" <?php if($nose!==false) echo "checked"; ?>>Nose
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Skin" <?php if($skin!==false) echo "checked"; ?>>Skin
                                            </label>
											<label class="checkbox-inline">
												<input type="checkbox" name="abnorm[]" id="abrnorm" value="Speech" <?php if($speech!==false) echo "checked"; ?>>Speech
											</label>
										</div>
									</div>
                                        <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="medallergy" id="medallergy" value="<?=$open['M_ALLERGY']?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="otherallergy">Other Allergies</label>
                                                <input type="text" class="form-control" name="otherallergy" id="otherallergy" value="<?=$open['O_ALLERGY']?>">
                                            </div>
                                        </div>
									<div class="col-md-6 col-lg-6">
										<div class="form-group">
											<label for="healthprob">Other Health Problems</label>
											<textarea class="form-control" rows="3" name="healthprob" id="healthprob"><?=$open['HEALTH_PROB']?></textarea>
										</div>
									</div>
								</div>
							</div>
                            ...
                            <div class="panel panel-default">
								...
								<div class="col-md-4 col-lg-4">
									<div class="form-group">
										...
										<input type="number" class="form-control" name="preg" id="pregnancy" value="<?=$open['PREG']?>">
									</div>
								</div>
								<div class="col-md-12 col-lg-12">
									<div class="form-group">
								...
								<div class="panel-body">
									...
									<div class="col-lg-6 col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control" name="numOccupants" id="occup" min="1" value="<?=$open['H_OCCU']?>">
										</div>
										<div class="form-group">
											<label for="flrs">Number of Floors</label>
											<input type="number" class="form-control" name="numFloors" id="flrs" min="1" value="<?=$open['H_FLRS']?>">
										</div>
										<div class="form-group">
											<label for="rms">Number of Rooms</label>
											<input type="number" class="form-control" name="numRooms" id="rms" min="1" value="<?=$open['H_RMS']?>">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="panel-body">
									<div class="col-lg-6 col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control" name="elecExp" id="ebill" step = ".01" min="0" value="<?=$open['E_BILL']?>">
										</div>
										<div class="form-group">
											<label for="fuel">Fuel Expense</label>
											<input type="number" class="form-control" name="fuelExp" id="fuel" step = ".01" min="0" value="<?=$open['FUEL_EXP']?>">
										</div>
										<div class="form-group">
											<label for="wbill">Water Bill</label>
											<input type="number" class="form-control" name="waterExp" id="wbill" step = ".01" min="0" value="<?=$open['WATER_BILL']?>">
										</div>
										<div class="form-group">
											<label for="educexp">Educational Expense</label>
											<input type="number" class="form-control" name="educExp" id="educexp" step = ".01" min="0" value="<?=$open['EDUC_EXP']?>">
										</div>
										<div class="form-group">
											<label for="medexp">Medical Expense</label>
											<input type="number" class="form-control" name="medExp" id="medexp" step = ".01" min="0" value="<?=$open['MED_EXP']?>">
										</div>
										<div class="form-group">
											<label for="foodexp">Food Expense</label>
											<input type="number" class="form-control" name="foodExp" id="foodexp" step = ".01" min="0" value="<?=$open['FOOD_EXP']?>">
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="form-group">
											<label for="rent">Rent Expense</label>
											<input type="number" class="form-control" name="rentExp" id="rent" step = ".01" min="0" value="<?=$open['RENT_EXP']?>">
										</div>
										<div class="form-group">
											<label for="transpo">Transportation Expense</label>
											<input type="number" class="form-control" name="transExp" id="transpo" step = ".01" min="0" value="<?=$open['TRANSPO']?>">
										</div>
										<div class="form-group">
											<label for="clothing">Clothing Expense</label>
											<input type="number" class="form-control" name="clothExp" id="clothing" step = ".01" min="0" value="<?=$open['CLOTH_EXP']?>">
										</div>
										<div class="form-group">
											<label for="cpload">Cellphone Load Expense</label>
											<input type="number" class="form-control" name="cLoadExp" id="cpload" step = ".01" min="0" value="<?=$open['CP_LOAD']?>">
										</div>
										<div class="form-group">
											<label for="misc">Miscellaneous</label>
											<input type="number" class="form-control" name="otherExp" id="misc" step = ".01" min="0" value="<?=$open['OTHER_EXP']?>">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="panel-body">
									<div class="col-lg-6 col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="pFullName" id="pfull" value="<?=$open['P_NAME']?>">
										</div>
										<div class="form-group">
											<label for="poccu">Provider's Occupation</label>
											<input type="text" class="form-control" name="pOccupation" id="poccu" value="<?=$open['P_OCCU']?>">
										</div>
										<div class="form-group">
											<label for="reltop">Relationship to Patient</label>
											<input type="text" class="form-control" name="rToPatient" id="reltop" value="<?=$open['P_REL']?>">
										</div>
										<div class="form-group">
											<label for="pminc">Provider's Monthly Income</label>
											<input type="number" class="form-control" name="pMonthInc" id="pminc" step = ".01" min="0" value="<?=$open['P_INC']?>">
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
										<div class="form-group">
											<label for="aname">Name of Agency</label>
											<input type="text" class="form-control" name="agencyName" id="aname" value="<?=$open['A_NAME']?>">
										</div>
                                        <div class="form-group">
											<label for="ngo">NGO</label>
                                            <input type="text" class="form-control" name="ngo" id="ngo" value="<?=$open['A_NGO']?>">
										</div>
                                        <div class="form-group">
											<label for="go">GO</label>
                                            <input type="text" class="form-control" name="go" id="go" value="<?=$open['A_GO']?>">
										</div>
                                        <div class="form-group">
											<?php
											$pNeeds=$open['P_NEEDS'];
                                            ...
                                            <label class="checkbox-inline">
												<input type="checkbox" name="needsProvided[]" id="needsp" value="Food" <?php if($food!==false) echo "checked"; ?>>Food
											</label>
                                            <label class="checkbox-inline">
												<input type="checkbox" name="needsProvided[]" id="needsp" value="Education" <?php if($educ!==false) echo "checked"; ?>>Education
											</label>
                                            <label class="checkbox-inline">
												<input type="checkbox" name="needsProvided[]" id="needsp" value="Housing" <?php if($hous!==false) echo "checked"; ?>>Housing
											</label>
											<label class="checkbox-inline">
												<input type="checkbox" name="needsProvided[]" id="needsp" value="Medical Needs" <?php if($med!==false) echo "checked"; ?>>Medical Needs
											</label>
                                            <label class="checkbox-inline">
												<input type="checkbox" name="needsProvided[]" id="needsp" value="Clothing" <?php if($clo!==false) echo "checked"; ?>>Clothing
											</label>
                                            <label class="checkbox-inline">
												<input type="checkbox" name="needsProvided[]" id="needsp" value="Others" <?php if($oth!==false) echo "checked"; ?>>Others
											</label>
										</div>
									</div>
									<div class="col-lg-12 col-md-12">
										<div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="servicesProvided" id="svc"><?=$open['A_SERV']?></textarea>
										</div>
									</div>
								</div>
							</div>
                            ...
                            <div class="col-lg-6 col-md-6">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<input type="date" class="form-control" name="medDate" id="meddate" value="<?=$open['MED_DATE']?>">
									</div>
                                    <div class="form-group">
										<label for="cpdate">CP Clearance Date</label>
                                        <input type="date" class="form-control" name="cpDate" id="cpdate" value="<?=$open['CP_CLEAR_DATE']?>">
									</div>
                                    <div class="form-group">
										<label for="adate">Admission Date</label>
                                        <input type="date" class="form-control" name="admDate" id="adate" value="<?=$open['AD_DATE']?>">
									</div>
									<div class="form-group">
										<label for="sdate">Surgery Date</label>
										<input type="date" class="form-control" name="surgeDate" id="sdate" value="<?=$open['SUR_DATE']?>">
									</div>
                                    <div class="form-group">
										<label for="ddate">Discharge Date</label>
                                        <input type="date" class="form-control" name="dsDate" id="ddate" value="<?=$open['DC_DATE']?>">
									</div>
									<div class="form-group">
										<label for="fdate">Follow-Up Date</label>
										<input type="date" class="form-control" name="fDate" id="fdate" value="<?=$open['FF_DATE']?>">
									</div>
								</div>
                                </div>
							</div>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="medRemarks" id="medrem" value="<?=$open['MED_REM']?>">
										</div>
										<div class="form-group">
											<label for="cpclear">CP Clearance</label>
                                            <input type="text" class="form-control" name="cpRemarks" id="cpclear" value="<?=$open['CP_CLEAR_REM']?>">
										</div>
										<div class="form-group">
											<label for="adm">Admission</label>
											<input type="text" class="form-control" name="admRemarks" id="adm" value="<?=$open['AD_REM']?>">
										</div>
										<div class="form-group">
											<label for="srem">Surgery</label>
											<input type="text" class="form-control" name="surgeRemarks" id="srem" value="<?=$open['SUR_REM']?>">
										</div>
										<div class="form-group">
											<label for="drem">Discharge</label>
											<input type="text" class="form-control" name="dsRemarks" id="drem" value="<?=$open['DC_REM']?>">
										</div>
										<div class="form-group">
											<label for="frem">Follow-Up</label>
                                            <input type="text" class="form-control" name="fRemarks" id="frem" value="<?=$open['FF_REM']?>">
										</div>
									</div>
								</div>
							</div>
                            ...
                            <div class="form-group">
								<center>
									<input type="submit" value="Submit" class="btn btn-primary"><input type='hidden' name='iid' value='<?=$id?>'>
								</center>
							</div>
                        </div>
                    </form>
