...
<?php
    include 'link.php';
    $query = "SELECT fname, lname FROM intake WHERE defer = 'Y'";
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
              ...
              <div class="page-header">
                <h1>Deferred Intakes <span class="badge"><?=$length?></span></h1>
              </div>
            <div id="toRep">
              <center>
        ...
        $sql = "SELECT COUNT(*) FROM intake WHERE defer = 'Y'";
        ...
        $sql = "SELECT fname, lname, id FROM intake WHERE defer = 'Y' ORDER BY lname LIMIT $offset, $rowsperpage";
        $result = mysqli_query($link, $sql) or trigger_error("SQL", E_USER_ERROR);
