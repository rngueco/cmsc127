        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="alert alert-info alert-dismissible" role="alert">
                    ...
                    <strong>Tip:</strong> Click on the navigation links to toggle between different sections.
                </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-4 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name = "educBackground" id="educbg">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="pregnancy" id="pregnancy">
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-12">
                                            <div class="form-group">
